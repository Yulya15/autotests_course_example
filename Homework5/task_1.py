...
def letter_stat(our_str):
    ...
    :return: возвращаем словарь, в котором ключ - буква, значение - количество вхождений буквы в строку
    """
    # При помощи генератора создаем словарь, где ключом выступает уникальный элемент строки,
    # а значением - его количество вхождений (вычисляется методом count())
