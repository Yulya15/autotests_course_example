...
def repeats(our_str):
    """
    Функция преобразует строку путем добавления количества вхождений каждого символама с помощью постфикса формата _n
    :param our_str: строка, которую принимаем на вход
    :return: возвращаем новую строку с добавленным количеством
    """
    new_str = ''
    for i in our_str:
