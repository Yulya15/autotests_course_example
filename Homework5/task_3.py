...
def everything_for_your_cat(cats_data):
    """
    Функция формирует список данных о котиках и владельцах таким образом, чтобы
    для каждого владельца данные о всех его животных отображались в одной строке
