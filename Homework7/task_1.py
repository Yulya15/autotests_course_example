...
class Segment:
    """
    Класс Segment описывает отрезок с координатами точек (x1, y1), (x2, y2)
    """
    ...
    def length(self):
        """
        Нахождение длины отрезка по переданным координатам точек, с округлением до 2 знаков после запятой
